...
class CircleSingleLinkedList {
    ...
    public void countBoy(int startNo, int countNo, int nums) {
        ...
        /**
         * 当小孩报数时，让 first 和 helper 指针同时移动 （countNo - 1）次，然后出圈
        ...
        while (true) {
            ...
            // 让 first 和 helper 指针同时移动 （countNo - 1）次
            for (int i = 0; i < countNo - 1; i++) {
                first = first.getNext();
                helper = helper.getNext();
            }
            // 这是 first 指向的节点，就是要出圈的小孩节点
